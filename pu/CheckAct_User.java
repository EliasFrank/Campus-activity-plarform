...
public class CheckAct_User extends JFrame {
	...
	public CheckAct_User() {
		...
		label = new JLabel("\u8BF7\u9009\u62E9\u8981\u901A\u8FC7\u5BA1\u6838\u7684\u6D3B\u52A8\u53C2\u4E0E\u8005");
		...
		button_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(selectedValues.length == 0) {
					new ErrorTip("提示", "请选择一项再进行操作");
					return;
				}
				for (int i = 0; i < selectedValues.length; i++) {
					String sql = "update user_act set pass=1 where activity=" 
		...
		JLabel label_1 = new JLabel("\u662F\u5426\u4F7F\u8FD9\u4E9B\u4EBA\u53C2\u52A0\u6D3B\u52A8\uFF1F");
	...
	public void addList() {
		...
		try {
			ps.println("select * from user_act where pass=0");
			String line;
